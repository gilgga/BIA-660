"""
* Name: sentiwords.py
* Description: BIA-660-WS Homework 1 - Senti Words
...
#function that reads in a file with reviews and a file with positive words
...
def run( reviews_file, positive_words_file  ):
    ...
    max_count = -1  # Keeps track of the current max value for the frequency with which a word appeared after a positive word
    most_frequent_word = "" # Keeps track of the word that has appeared the most after a positive word
...
if __name__ == "__main__":
    most_frequent_word = run('testfiles/textfile', 'lexicon/positive-words.txt')
